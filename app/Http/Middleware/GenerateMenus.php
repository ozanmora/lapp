...
class GenerateMenus
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        \Menu::make('AdminSidebarMenu', function ($menu) {
            ...
            $menu->add(trans('admin.menu.permission_management'), [ 'route' => 'admin.permissions' ])->prepend(trans('admin.icon.permission_management').'&nbsp; ')->nickname('admin.permission_management');
        });
